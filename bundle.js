...
function ensureMarkers() {
  ...
  for (const t of EDGE_TYPES) {
    const m2 = gDefs.append("marker").attr("id", `arrow-${t}`).attr("markerUnits", "strokeWidth").attr("viewBox", "0 -3 6 6").attr("refX", 6).attr("refY", 0).attr("markerWidth", 6).attr("markerHeight", 6).attr("orient", "auto-start-reverse");
